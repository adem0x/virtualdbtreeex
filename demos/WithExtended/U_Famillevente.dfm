object F_Famillevente: TF_Famillevente
  Left = 125
  Top = 166
  Width = 871
  Height = 500
          ...
          object Panel6: TPanel
            ...
            object lv_ssfam: TDBGroupView
              ...
              Columns = <
                ...
                item
                  AutoSize = True
                  Caption = 'types de produit membre'
                end>
              ...
              Datasource = M_Donn.ds_fave_sofv
              DataKeyUnit = 'SOFV_Clep'
              DataFieldDisplay = 'SOFV_Clep;SOFV_Libelle'
              DataShowAll = True
              SortColumn = -1
              DataSourceOwner = M_Donn.ds_fave
              DataKeyOwner = 'FAVE_Clep'
              DataTableOwner = 'FAMILLE_VENTE'
              DataFieldUnit = 'SOFV_Clep'
              DataFieldGroup = 'SOFV__FAVE'
              DataTableGroup = 'SOUS_FAMILLEV'
              ButtonTotalIn = bt_in_total
              ButtonIn = bt_in_item
              DataTableUnit = 'SOUS_FAMILLEV'
