object F_Comportement: TF_Comportement
  Left = 87
  Top = 236
  Width = 888
  Height = 500
  HelpContext = 9200
  Caption = 'Comportement d'#39'action des branches'
  Color = clBtnFace
  ...
  Key = 'CPTM_Clep'
  Table = 'COMPORTEMENT'
      Datasource = M_DmCompose.ds_Comportem
    end>
  MCVersion = '1.6.5.1'
  PixelsPerInch = 96
  TextHeight = 13
    ...
    object pa_3: TPanel
      ...
      object pc_ComposeStru: TPageControl
        ...
        object ts_Comporte: TTabSheet
          Caption = 'Une action sur une de ces branches'
          ImageIndex = 2
          ...
          object pa_Boutons: TPanel
            ...
            object bt_Structure: TJvXpButton
              ...
              Width = 22
              Height = 23
              Hint = 'Acc'#233'der '#224' la fiche Structure'
              Align = alLeft
              ParentShowHint = False
              ShowHint = True
        ...
        object ts_Selection: TTabSheet
          Caption = 'Appliquera le comportement '#224' l'#39'ensemble de ces branches'
          ImageIndex = 1
