object F_Gamme: TF_Gamme
        ...
        object ts_ssfam: TTabSheet
          ...
          object Panel6: TPanel
            ...
            object lsv_TypesIn: TDBGroupView
              ...
              DataFieldDisplay = 'TYPR_Clep;TYPR_Libelle'
              SortColumn = 1
        ...
        object TabSheet1: TTabSheet
          ...
          object Panel7: TPanel
            ...
            object bt_Desaffecte: TJvXpButton
              ...
              Width = 92
              Height = 23
              Hint = 'Supprimer l'#39'article de la gamme'
              Align = alLeft
          ...
          object Panel17: TPanel
            ...
            object Panel15: TPanel
              ...
              object lv_artin: TDBGroupView
                ...
                DBOnRecorded = lv_artinDBOnRecorded
                DataAllFiltered = False
              end
  ...
  object zq_maj: TIBQuery
    ...
    SQL.Strings = (
        ...
        'INSERT GAMME_TYPR SELECT distinct ARTI__GAMM,ARTI__TYPR from ART' +
        'ICLE'
      'WHERE ARTI__TYPR NOT IN '
      
        '(select GATY__TYPR from GAMME_TYPR where GATY__GAMM = ARTI__GAMM' +
        ') and ARTI__TYPR is not null and ARTI__GAMM is not null'
      ''
      
        'INSERT TYPE_PRODUIT_CARA SELECT distinct ARTI__TYPR,ARTI__CARA f' +
        'rom ARTICLE'
      'WHERE ARTI__CARA NOT IN '
      
        '(select TPCA__CARA from TYPR_CARA where TYPE_PRODUIT_CARA = ARTI' +
        '__TYPR) and ARTI__CARA is not null and ARTI__TYPR is not null an' +
        'd ARTI__GAMM is not null'
      ''
      '')
    Left = 104
    Top = 344
  end
  object zq_desaffecte: TIBQuery
    Database = M_Donnees.Database
    CursorType = ctStatic
    Params = <
      item
    ...
    SQL.Strings = (
        ...
        'UPDATE ARTICLE SET ARTI__GAMM = null, ARTI__TYPR = null,ARTI__CA' +
        'RA = null'
