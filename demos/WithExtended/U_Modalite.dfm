object F_Modalite: TF_Modalite
  Left = 109
  Top = 167
  Width = 933
  Height = 620
  Caption = 'Fiches des modalit'#233's'
  Color = clBtnFace
  ...
  NavEdit = nv_typModalite
  GridPanel = pa_2
  Navigator = nv_navModalite
  Grid = gd_modalite
  Navigator = nv_typModalite
  Grid = gd_typModalite
  Key = 'TYMO_Clep'
  Table = 'TYPE_MODALITE'
      Datasource = M_Donn.ds_typModalite
    end
    Item
    end
    Item
  Table = 'MODALITE'
  Navigator = nv_saisieModalite
  Panels = <
    Item
  Panel = pa_6
    end>
  Key = 'MODA__TYMO;MODA_Clep'
    Item
  DBKey = 'MODA__TYMO;MODA_Clep'
  LookupField = 'TYMO_Clep'
  DBTable = 'MODALITE'
  DBDatasource = M_Donn.ds_modalit
  Table = 'MODALITE'
  Navigator = nv_saisieModalite
  Panels = <
    Item
